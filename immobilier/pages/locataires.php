...
<div class="page-content">
  ...
  <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px;">
    <div>
      ...
      <p style="color:var(--text-muted); font-size:13px; margin-top:4px;">18 locataires actifs · 2 en attente</p>
    </div>
  ...
  <div class="card" style="margin-bottom:18px;">
    <div class="card-body" style="display:flex; gap:12px; flex-wrap:wrap; padding:16px 22px;">
      ...
      <select class="form-control form-select" style="width:160px; padding:8px 14px;">
        ...
        <option>Résidence Baobabs</option>
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            <?php
            $locataires = [
              [1,'Moussa Diop',    '77 123 45 67','moussa@email.com',    'Appt T3 – Bloc A',    '180 000','Jan 2024','Jan 2026','Actif'],
              [2,'Fatou Ndiaye',   '76 234 56 78','fatou@email.com',     'Studio – Bloc B',     '95 000', 'Mar 2024','Mar 2026','Actif'],
              [3,'Aminata Sow',    '70 345 67 89','aminata@email.com',   'Villa F4 – Sacré Cœur','350 000','Juil 2023','Juil 2025','Actif'],
              [4,'Omar Ba',        '78 456 78 90','omar@email.com',      'Appt T2 – Centre',    '120 000','Fév 2024','Fév 2026','Impayé'],
              [5,'Ndèye Fall',     '77 567 89 01','ndeye@email.com',     'Studio – HLM',        '80 000', 'Mai 2024','Mai 2026','Actif'],
              [6,'Ibrahima Sall',  '76 678 90 12','ibra@email.com',      'Appt T4 – Plateau',   '250 000','Oct 2023','Oct 2025','Actif'],
              [7,'Mariama Diallo', '70 789 01 23','mariama@email.com',   'Studio – Médina',     '75 000', 'Juin 2024','Juin 2026','En attente'],
            ];
            $colors = ['#3fb950','#1f6feb','#8b5cf6','#e3b341','#ec4899','#06b6d4','#f85149'];
            foreach($locataires as $i => $l):
              $statut_class = match($l[8]) {
                'Actif' => 'badge-success', 'Impayé' => 'badge-danger',
                'En attente' => 'badge-warning', default => 'badge-info'
              };
              $statut_icon = match($l[8]) {
                'Actif' => 'fa-circle-check', 'Impayé' => 'fa-circle-xmark',
